...
import MainImage from "../../assets/home-appliances.jpg";
    ...
    const fetchProducts = async () => {
      try {
        const res = await axios.get(
          "http://localhost:3005/category/home-appliances",
          {
  ...
  return (
    <div>
      ...
      <div className="w-full bg-black relative">
        ...
        />
        <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-xl sm:text-2xl md:text-4xl font-black text-center">
          Get the latest furnitures and home appliances
        </p>
        <div className="absolute top-0">
          <button
            className={`text-lg px-2  rounded-br-md ${
              showCategory ? "bg-primary-400 text-white" : "text-black bg-white"
            }`}
      ...
      <h2 className="text-center text-lg md:text-xl font-semibold mt-3">
        {products.length === 0
          ...
          : "Latest Products On Home Appliances"}
      </h2>
