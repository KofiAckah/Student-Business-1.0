...
import MainImage from "../../assets/services.jpeg";
...
export default function HomeAppliances() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await axios.get("http://localhost:3005/category/services", {
  ...
  return (
    <div>
      ...
      <h2 className="text-center text-lg md:text-xl font-semibold mt-3">
        {products.length === 0 ? "No Services available" : "Latest Services"}
      </h2>
