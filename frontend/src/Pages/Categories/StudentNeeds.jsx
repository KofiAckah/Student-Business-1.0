...
import MainImage from "../../assets/student-needs.jpg";

export default function StudentNeeds() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await axios.get(
          "http://localhost:3005/category/student-needs",
          {
    ...
    <div>
      ...
      <div className="w-full bg-black relative">
        ...
        <p className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-2xl md:text-4xl font-black text-center">
          Get your materials as a student
        </p>
      ...
      <h2 className="text-center text-lg md:text-xl font-semibold mt-3">
        {products.length === 0
          ...
          : "Latest Products On Student Needs"}
      </h2>
